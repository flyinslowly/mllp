...
from ..acquisitions import AcquisitionEI, AcquisitionMPI, AcquisitionLCB, AcquisitionEI_MCMC, AcquisitionMPI_MCMC, AcquisitionLCB_MCMC, AcquisitionLP, AcquisitionNEW
...
class ArgumentsManager(object):
    ...
    def acquisition_creator(self, acquisition_type, model, space, acquisition_optimizer, cost_withGradients):
        ...
        # new model type
        acquisition_addition_func = self.kwargs.get('rho_func')
        exploration_weight = self.kwargs.get('exploration_weight')
        ...
        elif acquisition_type =='NEW':
            return AcquisitionNEW(model, space, acquisition_optimizer, None, 
                exploration_weight, acquisition_addition_func)
